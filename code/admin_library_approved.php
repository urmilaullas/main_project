                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Approved Books</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Books Approved</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								<?php
								$n=0;
								$sql="Select book_id,book_name,auther,language,ctg_id,description,book,image from tbl_books where status=1";
