                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Waste Collection Completed</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Waste Collection Completed</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								...
								<?php
								$n=0;
								$sql="Select u.first_name,u.last_name,w.date,w.cid from tbl_user u inner join tbl_collect_wst w on w.user_id=u.user_id where w.status=1;";
