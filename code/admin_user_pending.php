            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <thead>
							...
							<?php
							$n=0;
								$sql="select user_id,first_name,last_name,age,gender,blood_grp,house_name,house_no,phone,email from tbl_user where 	user_type=1 and status=0";
							...
							while($r=mysqli_fetch_assoc($res))
							{
                        		...
                        		echo
									...
									<td class='text-left'>".$r['age']."</td>
                       				...
                       				<td class='text-left'>".$r['house_name']."</td>
                       				<td class='text-left'>".$r['house_no']."</td>
                       				<td class='text-left'>".$r['phone']."</td>
                       				<td class='text-left'>".$r['email']."</td>
                            	    <td class='text-left'><a href=user_accept.php?id=".$r['user_id'].">
											  <img src=../images/approve.png alt=Approve width='20px' height='20px' border=0>
											</a></td>
                                	<td class='text-left'><a href=user_reject.php?id=".$r['user_id'].">
