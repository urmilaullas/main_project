                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Medical Camp List</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								...
								<?php
								$n=0;
								$sql="Select mc_id,camp_id,date,time,location,status,count(dctr_id) as dctr,
case
when date<now() and status=1 then 'Conducted'
when date>=now() and status=1 then 'Active'
when status=0 then 'Canceled'
END AS status
 from tbl_medical_camp group by camp_id
";
