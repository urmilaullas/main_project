...
{
	if($_GET["x"]==1)
	echo "<script>alert('Payment Has Been Activated!!!');</script>";
	else
	echo "<script>alert('Payment Has Been Deactivated!!!');</script>";
		} 
?>
<!doctype html>
...
END AS status from tbl_payment_ctg";
								...
								{	
									...
									echo
										...
										if($r['status']=='Active')
										{
										echo "<td><a href=pay_deactivate.php?id=".$r['pay_ctg_id'].">
												  <img src=../images/deactivate.jpg alt=Deactivate width='20px' height='20px' border=0>Deactivate
												</a></td>";
										}
										else
										{
										echo "<td><a href=pay_activate.php?id=".$r['pay_ctg_id'].">
												  <img src=../images/activate.png alt=Activate width='20px' height='20px' border=0>Activate
												</a></td>";
										}
