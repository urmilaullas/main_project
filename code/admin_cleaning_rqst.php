...
include "dbconnection.php";
 if(!empty($_GET["x"]))
{
	echo "<script>alert('Cleaning Completed!!!');</script>";
} 
?>
<!doctype html>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Cleaning Requests</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Cleaning Requests</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								...
								<?php
								$n=0;
								$sql="Select u.first_name,u.last_name,c.subject,c.rqst,c.cl_id from tbl_user u inner join tbl_cleaning c on c.user_id=u.user_id where c.status=0;";
								...
								{	
									...
									echo
										...
										<td><a href=admin_cleaning_yes.php?id=".$r['cl_id'].">
