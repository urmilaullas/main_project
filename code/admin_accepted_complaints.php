            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <thead>
							...
							<?php
							$n=0;
								$sql="select u.first_name,u.last_name,c.cmp_id,c.subject,c.complaint from tbl_complaints c inner join tbl_user u on c.user_id=u.user_id where c.status=1";
							...
							while($r=mysqli_fetch_assoc($res))
							{
                        		...
                        		echo
                                	...
                                	<td class='text-left'><a href=complaint_reject1.php?id=".$r['cmp_id'].">
