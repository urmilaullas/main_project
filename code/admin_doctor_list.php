                  ...
                  <thead>
							  ...
							  <tbody>
								...
								if(isset($_POST['submit']))
								{
									...
									$sql="Select d.first_name,d.last_name,d.qualification,d.specialization from tbl_doctors d inner join tbl_medical_camp m on m.dctr_id=d.dctr_id where m.camp_id=$camp_id and dctr_status=1;";
									$res=mysqli_query($con,$sql);
									while($r=mysqli_fetch_assoc($res))
									{	
										$n=$n+1;
