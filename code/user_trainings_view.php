	...
	<div class="banner_bottom">
		<div class="container">
			...
			<div class="inner_sec_info">
				...
				<li>
					<select id="sort" name="slctsort" color="blue" style="width:42%;margin-right:20px;display:none;">
				...
				if($_POST['rdtype']==0)
					...
					else
					{
						...
						if($_POST['slctsort']==1)
						{
							...
							while($r=mysqli_fetch_assoc($res))
							{
									echo "<div><a target='_blank' href=tutorial_payment.php?id=".$r['tutorial_id']."><video width='200' height='200' controls>
									<source src='tutorial_video/".$r['video']."'type='video/mp4'></video>
