                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Approved Tutorials</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Approved Tutorials</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								<?php
								$n=0;
								$sql="Select tutrl_id,tutrl_name,ctg_id,video from tbl_tutorial where status=1";
							...
							while($r=mysqli_fetch_assoc($res))
							{
                        		...
                        		echo
                                	...
                                	<td class='text-left'><a href=tutorial_reject1.php?id=".$r['tutrl_id'].">
