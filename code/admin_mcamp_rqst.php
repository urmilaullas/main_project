        ...
        <div class="content mt-3">
            <div class="animated">
				...
				<div class="card-header">
                        <strong class="card-title" v-if="headerText">Send Request</strong>
                    </div>
					<div class="card-body">
					<form method="post" action="send_mc_rqst.php">
						<table style="margin-left:200px;">
							<tr>
							<td>
								<input type="label" value="Medical Camp Date">
							</td>
							<td>
								<input id="datepicker" name="mcdate" onchange="checkDate()" required type="date" data-date-format="yyyy-mm-dd">
							</td>
							</tr>
							<tr>
							<td>
								<input type="label" value="Medical Camp Time">
							</td>
							<td>
								<input id="time" name="mctime" required type="time" style="width:175px;">
							</td>
							</tr>
							<tr>
							<td>
								<input type="label" value="Medical Camp Location">
							</td>
							<td>
								<input id="location1" name="location" required type="text" style="width:175px;">
							</td>
							</tr>
							<tr>
							<td>
								<input type="Submit" value="Send Request" class="btn btn-outline-primary btn-lg" style="width:175px;">
							</td>
							<td>
