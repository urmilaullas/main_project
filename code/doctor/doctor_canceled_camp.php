                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Canceled By You</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Camps Canceled By You</strong>
                        </div>
                        <div class="card-body">
                 ...
                 <thead>
                          ...
                          <tbody>
							...
							$did=$_SESSION['id'];
							$n=0;
					 		$sql="Select mc_id,camp_id,date,time,location from tbl_medical_camp where status=1 and dctr_status=2 and dctr_id= $did and date>NOW()";
							...
							while($r=mysqli_fetch_assoc($res))
							{
                        		...
                        		echo
									...
									<td>".$r['time']."</td>
									<td>".$r['location']."</td>
									<td><a href=camp_approve_dctr.php?id=".$r['mc_id'].">
