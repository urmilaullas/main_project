                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Medical Camp Requests</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     <thead>
                          ...
                          <tbody>
							...
							$did=$_SESSION['id'];
							$n=0;
					 		$sql="Select mc_id,camp_id,date,time,location from tbl_medical_camp where status=1 and dctr_status=0 and dctr_id= $did and date>NOW()";
							...
							while($r=mysqli_fetch_assoc($res))
							{
                        		...
                        		echo
									...
									<td>".$r['time']."</td>
									<td>".$r['location']."</td>
									<td><a href=camp_approve.php?id=".$r['mc_id'].">
											  <img src=../images/approve.png alt=Approve width='20px' height='20px' border=0>
											</a></td>
                                	<td><a href=camp_reject.php?id=".$r['mc_id'].">
