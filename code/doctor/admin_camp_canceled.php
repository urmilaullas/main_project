                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Canceled List</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Camps Canceled By Admin</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                     <thead>
                          ...
                          <tbody>
							...
							$did=$_SESSION['id'];
							$n=0;
					 		$sql="Select distinct date,time,location from tbl_medical_camp where status=0 and date>NOW()";
