...
if(!empty($_GET["x"]))
{
	...
	echo "<script>alert('New Payment Category Has Been Added Successfully!!!');</script>";
}
?>
<!doctype html>
        ...
        <div class="content mt-3">
            <div class="animated">
				...
				<div class="card-header">
                        <strong class="card-title" v-if="headerText">Add Payments</strong>
                    </div>
					<div class="card-body">
					<form method="post" action="add_payment.php">
						<table style="margin-left:150px;width:70%;">
							<tr>
							<td>
								<input type="label" value="Payment Category">
							</td>
							<td>		
								<input type="text" name="payctg" list="ctg" />
								<datalist id="ctg" >
								<?php
									$sql="select distinct ctg_name from tbl_payment_ctg";
									$res=mysqli_query($con,$sql);
									while($r=mysqli_fetch_assoc($res))
									{
										echo "<option value=".$r['ctg_name'].">".$r['ctg_name']."</option>";
									}
								  ?>
								</datalist>
							</td>
							...
							<tr>
							<td>
								<input type="label" value="Year">
							</td>
							<td>
							<input type="number" min="1900" max="2099" step="1" value="2018" name="payyear" />
							</td>
							</tr>
							<tr>
							<td>
