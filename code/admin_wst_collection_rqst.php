...
include "dbconnection.php";
 if(!empty($_GET["x"]))
{
	echo "<script>alert('Waste Collection Completed!!!');</script>";
} 
?>
<!doctype html>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Waste Collection Requests</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Waste Collection Requests</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <thead>
							  ...
							  <tbody>
								...
								<?php
								$n=0;
								$sql="Select u.first_name,u.last_name,w.date,w.cid from tbl_user u inner join tbl_collect_wst w on w.user_id=u.user_id where w.status=0;";
								...
								{	
									...
									echo
										...
										<td><a href=admin_collect_yes.php?id=".$r['cid'].">
												  <img src=../images/approve.png alt=Reject width='20px' height='20px' border=0>
												</a></td>
										</tr>";
